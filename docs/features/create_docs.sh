...
<head>
  ...
  <meta name="description" content="Документация по функции DESCRIPTION">
...
for file in "${files[@]}"; do
  ...
  desc="Документация по функции: $title"
  
  echo "$base_template" | sed "s/TITLE/$title/g" | sed "s/DESCRIPTION/$desc/g" > "$file.html"
